...
namespace KP.ViewModel
{
    internal class FilmsViewModel:ViewModelBase
    {
        ...
        private ObservableCollection<MiniItemInfo> _actionCategory;
        private ObservableCollection<MiniItemInfo> _detectiveCategory;
        private ObservableCollection<MiniItemInfo> _fantasyCategory;
        ...
        public ObservableCollection<MiniItemInfo> ActionCategory
        {
            get
            {
        ...
        public ObservableCollection<MiniItemInfo> DetectiveCategory
        {
            get
            {
                return _detectiveCategory;
            }
            set
            {
                _detectiveCategory = value;
                OnPropertyChanged("DetectiveCategory");
            }
        }
        public ObservableCollection<MiniItemInfo> FantasyCategory
        {
            get
            {
                return _fantasyCategory;
            }
            set
            {
                _fantasyCategory = value;
                OnPropertyChanged("FantasyCategory");
            }
        }
