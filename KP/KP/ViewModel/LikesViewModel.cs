...
{
    internal class LikesViewModel:ViewModelBase
    {
        public static string Login;

        UnitOfWork unit;
        DbAppContext db = new DbAppContext();
        private ObservableCollection<MiniItemInfo> _likedMini;
        ...
        public LikesViewModel()
        {
            ...
            var likes = db.userLikes.Where(p => p.userID == user.ID);
            foreach (var mini in t)
            {
                foreach (var like in likes)
                {
                    if (like.miniItemInfoID == mini.ID)
                        kk.Add(mini);
                }
            }
...
*/           /* if (user != null)
        ...
        public ObservableCollection<MiniItemInfo> LikedMini
        {
            get
            {
                return _likedMini;
